...
- În funcția tearDwon() punem tot ce ne dorim să se execute după teste
...
- Data viitoare vom învăța cum să le punem în suite de teste (să le grupam logic)
...
class Test(TestCase):  # mosteneste clasa TestCase


    # elementele din pagina / definim constantele
    ...
    def test_check_url(self):
        ...
        self.assertEqual(actual, expected, f'Pagina deschisa nu este corecta, am gasit {expected}')
        # adica compar actual cu expected si tre sa fie egale
